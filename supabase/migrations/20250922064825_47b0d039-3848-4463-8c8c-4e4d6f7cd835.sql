...
DROP POLICY IF EXISTS "Admins can manage refrigerators" ON public.refrigerators;
DROP POLICY IF EXISTS "Anyone can view refrigerators" ON public.refrigerators;
...
DROP TRIGGER IF EXISTS update_refrigerators_updated_at ON public.refrigerators;
